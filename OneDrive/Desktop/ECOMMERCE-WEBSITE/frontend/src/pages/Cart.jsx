...
import { removeFromCart, updateCartQuantity, fetchCart, removeFromCartAPI, updateCartItemAPI } from '../features/products/user/userSlice';
...
function Cart() {
  ...
  const shipping = selectedItems.length > 0 ? 50 : 0; // ₹50 shipping if items selected
  ...
  const handleQuantityChange = (productId, newQuantity) => {
    ...
    // Use API function for database update
              ...
              {cart.map((item) => (
                <div key={item._id} className="cart-item">
                  <div className="item-product">
                    ...
                    />
                    <img 
                      src={item.image[0]?.url?.replace('./', '/') || '/images/default.jpg'} 
                      alt={item.name}
